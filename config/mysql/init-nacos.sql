...
VALUES (1, 'g2rain-gateway.yml', 'g2rain-gateway',
       ...
       (53, 'g2rain-department.yml', 'g2rain-department',
        ...
        '', 'g2rain-test', '', '', '', 'yaml', '', ''),
       (54, 'g2rain-member.yaml', 'g2rain-member',
        'spring:\n  # 非关系型数据库配置\n  data:\n    # redis 配置\n    redis:\n      # 主机地址\n      host: redis\n      # 端口\n      port: 6379\n      #密码\n      password: g2rain_redis_11050826\n      # redis 数据库\n      database: 0\n      # 读写超时\n      timeout: 5s\n      # 连接超时\n      connect-timeout: 2s\n      # 连接池\n      lettuce:\n        pool:\n          # 最大活跃数量\n          max-active: 8\n          # 最大空闲数量\n          max-idle: 8\n          # 最小空闲数量\n          min-idle: 0\n          # 最大等待周期\n          max-wait: -1ms\n\n\n  datasource:\n    url: jdbc:mysql://mysql:3306/g2rain_member?useUnicode=true&characterEncoding=utf-8&useSSL=true&zeroDateTimeBehavior=convertToNull&serverTimezone=GMT%2B8\n    username: root\n    password: g2rain123456\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    hikari:\n      connection-timeout: 30000\n      validation-timeout: 3000\n      idle-timeout: 30000\n      max-lifetime: 300000\n      minimum-idle: 1\n      maximum-pool-size: 10\n      connection-test-query: select 1',
        'c5002b5a3e72e33e741449c98d8f7d78', '2026-09-14 12:00:00', '2026-09-14 12:00:00', 'nacos', '127.0.0.1',
        '', 'g2rain-test', '', '', '', 'yaml', '', '');
