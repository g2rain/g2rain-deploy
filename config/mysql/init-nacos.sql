...
VALUES (1, 'g2rain-gateway.yml', 'g2rain-gateway',
       ...
       (23, 'g2rain-health.yml', 'g2rain-health',
        'spring:\n  # 非关系型数据库配置\n  data:\n    # redis 配置\n    redis:\n      # 主机地址\n      host: redis\n      # 端口\n      port: 6379\n      #密码\n      password: g2rain_redis_11050826\n      # redis 数据库\n      database: 0\n      # 读写超时\n      timeout: 5s\n      # 连接超时\n      connect-timeout: 2s\n      # 连接池\n      lettuce:\n        pool:\n          # 最大活跃数量\n          max-active: 8\n          # 最大空闲数量\n          max-idle: 8\n          # 最小空闲数量\n          min-idle: 0\n          # 最大等待周期\n          max-wait: -1ms\n\n\n  datasource:\n    url: jdbc:mysql://mysql:3306/g2rain-health?useUnicode=true&characterEncoding=utf-8&useSSL=true&zeroDateTimeBehavior=convertToNull&serverTimezone=GMT%2B8\n    username: root\n    password: g2rain123456\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    hikari:\n      connection-timeout: 30000\n      validation-timeout: 3000\n      idle-timeout: 30000\n      max-lifetime: 300000\n      minimum-idle: 1\n      maximum-pool-size: 10\n      connection-test-query: select 1',
        '45031d2347dde361668139043100cebd', '2026-04-01 20:07:25', '2026-04-14 21:15:31', 'nacos', '120.245.114.39', '',
        'g2rain-test', '', '', '', 'yaml', '', ''),
       (26, 'g2rain-health.yml', 'g2rain-health',
        ...
        '2c8521a6ece2ec5fae71b63ce6bec72d', '2026-04-02 20:32:38', '2026-04-02 20:38:59', 'nacos', '1.202.120.212', '',
        'g2rain-dev', '', '', '', 'text', '', ''),
