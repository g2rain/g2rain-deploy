...
V1 与 V2 主配置静态解析后均包含 15 个服务：MySQL、Redis、Nacos、Kafka、Nginx、Gateway，以及 Infra、Basis、IAM、Department、Member 五个后端和 Main Shell、Infra App、Manager App、Department App、Member App 五个前端应用。
